...
| `llama31-8b` | `bartowski/Meta-Llama-3.1-8B-Instruct-GGUF` | `Meta-Llama-3.1-8B-Instruct-Q4_K_M.gguf` | ~6-8 GB | Minimal generation model for constrained GPU setups |
...
Downloaded artifacts and the Hugging Face cache stay under ignored paths in `models/downloads/` and `models/cache/`.
